...
import footerLogo from '../../../assets/images/resources/logoPagina.png';
                ...
                <div className="container">
                    <div className="site-footer__top-inner">
                        <div className="site-footer__logo">
                            <Link to="/">
                                <img src={footerLogo} alt="Logo Elite" />
                            </Link>
                        </div>
                            ...
                            >
                                <div className="footer-widget__column footer-widget__link">
                                    <div className="footer-widget__title-box">
                                        <h3 className="footer-widget__title">Accesos Rápidos</h3>
                                    </div>
                ...
                <div className="container">
                    <div className="site-footer__bottom-inner">
                        <p className="site-footer__bottom-text">
                            &copy; {new Date().getFullYear()} - <a href="https://www.linkedin.com/in/cristian-marambio-a1b18743/" target="_blank" rel="noopener noreferrer">Cristian Marambio</a>
                        </p>
                    </div>
                </div>
            </div>
