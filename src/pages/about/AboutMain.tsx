          ...
          <div className="container" style={{ height: '800px' }}>
            ...
            <div className="row">
              <div className="col-xl-6">
                ...
                >
                  <div className="section-title__tagline-box">
                    <span className="section-title__tagline" data-aos="fade-zoom" data-aos-duration="1500" data-aos-delay="400">NUESTRO EQUIPO</span>
                  </div>
                  <p className="buy-ticket__text" style={{ textAlign: 'justify', fontSize: '20px' }} data-aos="fade-right" data-aos-duration="1200" data-aos-delay="100" >
              ...
              <div className="col-xl-6">
                ...
                >
                  <div className="buy-ticket__img" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="100">
                    <img
                      src={bayticket}
                      alt="" />
                  </div>
